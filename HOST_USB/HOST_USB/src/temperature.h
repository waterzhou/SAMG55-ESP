...
#define USART_BAUDRATE_TEM				195312UL//115200UL
#define USART_PARITY_TEM					US_MR_PAR_EVEN//US_MR_PAR_NO
#define USART_CHRL_TEM						US_MR_CHRL_8_BIT
#define USART_NBSTOP_TEM					US_MR_NBSTOP_1_BIT
