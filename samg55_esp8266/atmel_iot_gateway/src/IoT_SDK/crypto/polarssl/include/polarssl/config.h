...
/* Platform options */
#define POLARSSL_PLATFORM_STD_MEM_HDR		"config/rtos.h" /**< Header to include if POLARSSL_PLATFORM_NO_STD_FUNCTIONS is defined. Don't define if no header is needed. */
#define POLARSSL_PLATFORM_STD_MALLOC		IoT_pvPortMalloc /**< Default allocator to use, can be undefined */
#define POLARSSL_PLATFORM_STD_FREE		IoT_vPortFree /**< Default free to use, can be undefined */
