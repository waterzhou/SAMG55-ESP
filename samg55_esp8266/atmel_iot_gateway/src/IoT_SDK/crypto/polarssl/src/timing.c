...
{
	/* return milliseconds */
	return IoT_xTaskGetTickCount() * (1000/configTICK_RATE_HZ);
}
...
unsigned long get_timer( struct hr_time *val, int reset )
{
    ...
    struct _hr_time *t = (struct _hr_time *) (void *)val;

    //gettimeofday( &offset, NULL );
	offset.tv_sec = hardclock() / 1000; //seconds
	offset.tv_usec = hardclock() % 1000; //milliseconds
